...
<p class="lede">This is an interactive model of a single question: <b>if</b> cultivated (lab-grown)
meat can be produced at a given cost, what share of the meat market does it win — and how soon? It is a
transparent, fully-sourced techno-economic <i>and</i> demand model: every assumption is a labelled
slider, the defaults are the neutral or measured values, and the sliders are ordered most-decisive
first. Drag any of them to watch the price ratio, market shares, and per-meat-type penetration update
live.</p>
